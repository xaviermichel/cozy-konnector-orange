How to contribute to Cozy Konnector Orange?
===========================================
...
- What is the version of the Cozy Konnector Orange?
...
```
$ git clone github.com/cozy/cozy-konnector-orange.git
$ cd cozy-konnector-orange
$ git remote add fork git://github.com/yourusername/cozy-konnector-orange.git
```
...
Go to https://github.com/yourusername/cozy-konnector-orange and select your branch. Click the 'Pull Request' button and fill out the form.
...
The Cozy Konnector Orange is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/cozy-konnector-orange/issues/new
...
[localization]: https://github.com/cozy/cozy-konnector-orange/blob/master/README.md#localization
